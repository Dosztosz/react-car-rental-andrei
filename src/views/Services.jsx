    ...
    <div className="py-28 bg-lightest-gray">
      ...
      items-start lg:items-center gap-6 lg:gap-12 mg-9">
        ...
        <p className="text-subtitle-gray flex-1 text-center">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Eaque facere iste quos inventore repellendus error nihil earum enim, omnis corrupti?
        </p>
      </div>
