    ...
    <div className="wrapper flex justify-between items-center py-5">
      ...
      <div className="hidden lg:block">
        <ul className="flex items-center gap-10">
          ...
          <li className="link border-transparent">Home</li>
      ...
      <Drawer className="px-6 py12 rounded-r-lg flex flex-col gap-16" open={open} onClose={closeDrawer}>
        ...
        <div className="w-full h-[2px] bg-primary-green rounded-full"></div>

        <div className="hidden lg:flex items-center gap-[30px]">
            <button className="btn_base text-primary-black hover:text-primary-green">Login</button>
            <button className="btn_base text-primary-black border-2 border-primary-green rounded-full py-2 px-5 hover:bg-primary-green hover:border-transparent hover:text-white">Sign up</button>
        </div>
